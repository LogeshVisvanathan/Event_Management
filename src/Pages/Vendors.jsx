            ...
            >
              ...
              <div className="flex flex-1 flex-col gap-2">
                ...
                <p className="text-[11px] text-slate-600">
                  Specialised in {v.role.toLowerCase()} for weddings, engagements,
                ...
                <div className="mt-3 flex gap-2">
                  <Link
                    ...
                    className="flex-1 rounded-full border border-slate-200 bg-white px-3 py-2 text-[11px] font-medium text-slate-700 transition hover:border-sky-300 hover:text-sky-700 text-center"
                  >
                    View Profile
                  </Link>

                  <Link
                    to={`/book/${encodeURIComponent(v.id)}`}
                    className="flex-1 rounded-full bg-gradient-to-r from-sky-500 via-cyan-400 to-emerald-400 px-3 py-2 text-[11px] font-semibold text-white shadow-md transition hover:shadow-lg text-center"
                  >
                    Book Now
                  </Link>
                </div>
